...
class Multilayerneuralnetwork(object):
    ...
    def __init__(self):
        ...
        # head_to_goal
        self.trainingset = [
            [0.9, 0.1, 0.1, 0.5, 0.67, 0.32, 0.67, 0.32, 0.67, 0.32, 0.9, 0.1, 0.1],
            [0.1, 0.9, 0.1, 0.5, 0.67, 0.32, 0.67, 0.32, 0.67, 0.32, 0.1, 0.9, 0.1],
            [0.1, 0.1, 0.9, 0.5, 0.67, 0.32, 0.67, 0.32, 0.67, 0.32, 0.1, 0.1, 0.9],

            [0.67, 0.67, 0.67, 0.5, 0.9, 0.32, 0.1, 0.32, 0.1, 0.32, 0.1, 0.1, 0.9],
            [0.67, 0.67, 0.67, 0.5, 0.1, 0.32, 0.9, 0.32, 0.1, 0.32, 0.1, 0.1, 0.9],
            [0.67, 0.67, 0.67, 0.5, 0.1, 0.32, 0.1, 0.32, 0.9, 0.32, 0.1, 0.9, 0.1],

            [0.67, 0.67, 0.67, 0.5, 0.32, 0.9, 0.32, 0.1, 0.32, 0.1, 0.1, 0.9, 0.9],
            [0.67, 0.67, 0.67, 0.5, 0.32, 0.1, 0.32, 0.9, 0.32, 0.1, 0.9, 0.1, 0.9],
            [0.67, 0.67, 0.67, 0.5, 0.32, 0.1, 0.32, 0.1, 0.32, 0.9, 0.1, 0.1, 0.9],
        ...
        self.testset = [
            ...
            [0.67, 0.67, 0.67, 0.5, 0.32, 0.9, 0.32, 0.1, 0.32, 0.1, 0.1, 0.5, 0.5],
            [0.67, 0.67, 0.67, 0.5, 0.32, 0.1, 0.32, 0.9, 0.32, 0.1, 0.5, 0.1, 0.5],
            [0.67, 0.67, 0.67, 0.5, 0.32, 0.1, 0.32, 0.1, 0.32, 0.9, 0.1, 0.1, 0.5],

            [0.67, 0.67, 0.67, 0.1, 0.32, 0.67, 0.32, 0.67, 0.32, 0.67, 0.1, 0.9, 0.1],
            [0.67, 0.67, 0.67, 0.5, 0.32, 0.67, 0.32, 0.67, 0.32, 0.67, 0.5, 0.5, 0.9],
            [0.67, 0.67, 0.67, 0.9, 0.32, 0.67, 0.32, 0.67, 0.32, 0.67, 0.9, 0.5, 0.5]
        ]

        self.numinputs = len(self.trainingset)
        self.numinputvalues = 10
        self.numoutputvalues = 3

        self.neuralnetwork = Neuralnetwork(10, 10, 3, 0.2, 0.9)
        self.trainnetwork()
